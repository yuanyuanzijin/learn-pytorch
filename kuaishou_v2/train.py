...
def train():
    ...
    train_data = AppData("data/train_20d_2p_ap.json", iflabel=True)
    val_data = AppData("data/val_20d_2p_ap.json", iflabel=True)
    ...
    test_data = AppData("data/test_20d_2p_ap.json", iflabel=True)
